...
public class PostController {
	...
	/*
	 * @GetMapping("detail/{postNo}") public String getPostDetail(Model
	 * model, @PathVariable int postNo, @RequestParam int boardNo) { Post post =
	 * postService.getPost(postNo, true); model.addAttribute("post", post);
	 * 
	 * Integer prePostNo = postService.getPrePostNo(postNo, boardNo); Integer
	 * nextPostNo = postService.getNextPostNo(postNo, boardNo);
	 * 
	 * model.addAttribute("previousPostNo", prePostNo);
	 * model.addAttribute("nextPostNo", nextPostNo);
	 * 
	 * return "postDetail"; }
	 */
